...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(62), __webpack_require__(14), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, U, ArtefactP) {
		'use strict';
		...
		return ArtefactP.then(function (Artefact) {
			...
			window._amy_D3Group = Artefact.newSubclass('D3Group', function D3Group() {
				...
				region: Object.defineProperties({ // the whole canvas with a small padding
					top: 10,
					left: 10 }, {
					width: {
						get: function () {
...
;
//# sourceMappingURL=D3Group.js.map