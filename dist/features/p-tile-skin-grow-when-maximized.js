...
})(this, function(__WEBPACK_EXTERNAL_MODULE_62__, __WEBPACK_EXTERNAL_MODULE_63__, __WEBPACK_EXTERNAL_MODULE_65__, __WEBPACK_EXTERNAL_MODULE_66__, __WEBPACK_EXTERNAL_MODULE_67__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(62), __webpack_require__(12), __webpack_require__(96)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, Kefir) {
		'use strict';
		...
		plugin.append('construct', function () {
			...
			this.p('maximized').onValue(function () {
				sectionElement.css('opacity', 0);
			});
			Kefir.merge([this.p('fullyMaximized').changes().value(true), this.p('fullyNotMaximized').changes().value(true)]).onValue(function () {
				if (open) {
...
;
//# sourceMappingURL=p-tile-skin-grow-when-maximized.js.map