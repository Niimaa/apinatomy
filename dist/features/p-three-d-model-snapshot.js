		...
		plugin.append('Snapshot.prototype.take', function () {
			...
			if (this.options.threeDModelsVisible) {
				...
				this.circuitboard.traverseArtefactsByType('ThreeDModel', function (model) {
					if (model.visible) {
						_this.object.threeDModelsVisible[model.id] = true;
					}
				});
			}
			...
			if (this.options.threeDModelsHidden) {
				...
				this.circuitboard.traverseArtefactsByType('ThreeDModel', function (model) {
					if (model.hidden) {
						_this.object.threeDModelsHidden[model.id] = true;
					}
				});
			}
			...
			if (this.options.threeDModelsVisible) {
				Object.keys(this.object.threeDModelsVisible).forEach(function (id) {
					_this2.circuitboard.artefactById(id).then(function (model) {
						model.visible = _this2.object.threeDModelsVisible[id];
					});
				});
			}
			...
			if (this.options.threeDModelsHidden) {
				Object.keys(this.object.threeDModelsHidden).forEach(function (id) {
					_this2.circuitboard.artefactById(id).then(function (model) {
						model.hidden = _this2.object.threeDModelsHidden[id];
					});
				});
			}
		});
...
;
//# sourceMappingURL=p-three-d-model-snapshot.js.map