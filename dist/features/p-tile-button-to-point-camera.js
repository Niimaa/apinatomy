...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(62), __webpack_require__(69), __webpack_require__(15), __webpack_require__(12)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, color, U, Kefir) {
		'use strict';
		...
		var blackIcon = __webpack_require__(104);
		var whiteIcon = __webpack_require__(105);
		...
		plugin.append('Circuitboard.prototype.construct', function () {
			...
			this.p('cameraTargetTile').plug(newTileTarget.flatMapLatest(function (tile) {
				return tile.p('hidden').value(true).merge(_this.on('destroy')).takeUntilBy(_this.p('cameraTargetTile').value(null));
			}).mapTo(null));
			...
			newTarget.flatMapLatest(function (tile) {
				...
				_this.camera3D.userData.target = _this.object3D.localToWorld(tile.object3D.position.clone());
				_this.camera3D.userData.semanticTarget = tile;
			});
			newTarget.value(null).onValue(function () {
				delete _this.camera3D.userData.semanticTarget;
			});
	
			/* when a new tile is targeted, change the color of its camera button */
			newTarget.newOld().onValue(function (_ref) {
				var _ref2 = _slicedToArray(_ref, 2);
	
				var newTarget = _ref2[0];
				var oldTarget = _ref2[1];
	
				if (newTarget) {
					var lightBackground = color(newTarget.element.css('backgroundColor')).luminance() > 0.5;
				...
				if (oldTarget) {
					var lightBackground = color(oldTarget.element.css('backgroundColor')).luminance() > 0.5;
			...
			this.addButton({ name: 'pointCamera', icon: { white: whiteIcon, black: blackIcon } }).onValue(function () {
				if (_this2.circuitboard.cameraTargetTile === _this2) {
					_this2.circuitboard.cameraTargetTile = null;
				} else {
					_this2.circuitboard.cameraTargetTile = _this2;
				}
			});
		});
	}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2018c34055e85c89ba70885da1aa8d56.png"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "e2dfb839556f09dc33e218917a5f8c69.png"
...
;
//# sourceMappingURL=p-tile-button-to-point-camera.js.map