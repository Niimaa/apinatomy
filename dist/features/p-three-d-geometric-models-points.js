(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jquery"), require("bluebird"), require("three-js"));
	else if(typeof define === 'function' && define.amd)
		define(["jquery", "bluebird", "three-js"], factory);
	else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(15), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, THREE, U) {
		'use strict';
		...
		function coordsToGeometry(_ref) {
		...
		plugin.add('Circuitboard.threeJsLoaders.points', U.newSubclass(THREE.EventDispatcher, function (superFn) {
			...
			load: function load(url, callback) {
				...
				xhr.addEventListener('load', function (_ref2) {
					var _ref2$target = _ref2.target;
					var status = _ref2$target.status;
					var response = _ref2$target.response;
					var statusText = _ref2$target.statusText;
	
					if (status === 200 || status === 0) {
	
						/* generate the 3D object */
						var geometry = coordsToGeometry(_this.parse(response));
	
						/* transmit that object in both supported ways */
						_this.dispatchEvent({ type: 'load', content: geometry });
						if (callback) {
							callback(geometry);
						}
					} else {
				...
				xhr.addEventListener('progress', function (_ref3) {
					var loaded = _ref3.loaded;
					var total = _ref3.total;
	
					_this.dispatchEvent({ type: 'progress', loaded: loaded, total: total });
				}, false);
	
				/* on an error loading the file */
				xhr.addEventListener('error', function () {
					_this.dispatchEvent({ type: 'error', message: 'Couldn\'t load URL [' + url + ']' });
				}, false);
...
;
//# sourceMappingURL=p-three-d-geometric-models-points.js.map