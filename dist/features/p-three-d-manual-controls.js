...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(4), __webpack_require__(15), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, U, THREE, Kefir) {
		'use strict';
				...
				_this.on('3d-render').takeWhileBy(_this.p('threeDMode')).onValue(function () {
					...
					if (somethingChanged || _this.currentArrowKey) {
						...
						(function () {
							...
							var factor = 1.0 + (_this._zoomEnd.y - _this._zoomStart.y) * _this.zoomSpeed; // set factor
